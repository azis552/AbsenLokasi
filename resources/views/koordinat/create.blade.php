...
@section('title', 'Tambah koordinat')
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('koordinat.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div id="map" style="height: 400px;"></div>
                            <div class="form-group">
                                <label for="nama_lokasi">Nama Lokasi</label>
                                <input type="text" class="form-control @error('nama_lokasi') is-invalid @enderror"
                                    name="nama_lokasi" id="nama_lokasi" value="{{ old('nama_lokasi') }}" placeholder="Masukkan nama lokasi">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('radius') is-invalid @enderror"
                                    name="radius" id="radius" value="{{ old('radius',100) }}" placeholder="Masukkan radius">
                                <!-- error message untuk keterangan kelas -->
                                @error('radius')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
